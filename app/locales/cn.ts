  ...
  Settings: {
    ...
    Sync: {
      ...
      Overview: (overview: any) => {
        return `${overview.chat} 次对话，${overview.message} 条消息，${overview.prompt} 条提示词，${overview.mask} 个专家`;
      },
      ImportFailed: "导入失败",
    },
    Mask: {
      Splash: {
        Title: "专家启动页",
        SubTitle: "新建聊天时，展示专家启动页",
      },
      Builtin: {
        Title: "隐藏内置专家",
        SubTitle: "在所有专家列表中隐藏内置专家",
      },
    },
    Prompt: {
      Disable: {
